...
namespace UdemyCarBook.Application.Validators.ReviewValidators
{
    public class UpdateReviewValidator : AbstractValidator<UpdateReviewCommand>
    {
        public UpdateReviewValidator()
        {
            ...
            RuleFor(x => x.CustomerImage).NotEmpty().WithMessage("Lütfeen müşteri görselini boş geçmeyiniz!").MinimumLength(10).WithMessage("Lütfen en az 10 karakter uzunluğunda giriş yapınız!").MaximumLength(200).WithMessage("Lütfen en fazla 200 karakter uzunluğunda giriş yapınız!");
        }
    }
}